...
public class PSIDAG {
    ...
    public List<PSIDAGEdge> edgelist = new ArrayList<PSIDAGEdge>();
    
    public List<PSINFEdge> nfedgelist = new ArrayList<PSINFEdge>();
    ...
    public List<PSIDAGEdge> getDAGEdges(){
        return edgelist;
    }
    ...
    public List<PSINF> getNeighbors(PSINF nf){
        return neighbors.get(nf);
    }
    /*
     * return node by key
     * */
