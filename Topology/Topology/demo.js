...
addSwitchWithID = function(idstr){
   //idNum = cy.nodes().size(),
   //setID = idNum.toString(),
   //setID = idstr,
   cy.add([{group: "nodes",
            ...
            fr.onload = function () {
                ...
                for (var i = 0; i<lines.length; i++) {
                  ...
                  if ((enforcetag == 1)&&(customizetag == 0))
                  {
                      ...
                      addAssetWithID(elems[0]);
                      addAssetWithID(elems[1]);
                      //addSwitchWithID(elems[2]);
                      addEdgeWithID(elems[0],elems[1],elems[0]+elems[1]," ");
